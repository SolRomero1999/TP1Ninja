...
export default class Game extends Phaser.Scene {
    ...
    preload() {
      ...
      create() {
        this.add.image(400, 300, "Cielo").setScale(0.555); //Se agrega la imagen Cielo en la posición (400, 300)
        ...
        this.time.addEvent({ //crea un nuevo evento cronometrado
            ...
            callback: this.addShape, //nombre de la función que se ejecutará cada vez que se active el evento. En este caso, la función es this.addShape, que es la que agrega una nueva forma al juego
